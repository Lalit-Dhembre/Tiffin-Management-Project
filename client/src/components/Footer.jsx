    ...
    <footer>
      <div className="py-4 bg-slate-800 sm:grid text-white sm:grid-cols-2 sm:px-4 md:grid md:grid-cols-3 px-5 lg:grid lg:grid-cols-3 mt-2">
        <div className="naem order-1 pt-5 md:pl-7 lg:flex flex-col items-center ">
          <h1 className='font-bold text-3xl  md:text-4xl md:pt-1'>Meals Near You</h1>
          <p className='sm:text-xl sm:font-medium px-3 pt-4 text-lg font-normal md:px-0'>Your Daily dose of</p>
          <p className='sm:text-xl sm:font-medium px-3 text-lg font-normal md:px-0'> Homemade Goodness</p>
        </div>
        <div className="contactus py-4 order-2  md:py-4 lg:flex flex-col items-center">
          ...
          <ul className='flex flex-col '>
            ...
            />lalit@gmail.com<br></br>
              anuj@gmail.com<br></br>
              deep@gmail.com</li>
      ...
      {/* <div className=" py-4 bg-slate-700 text-white">
        <p className='text-normal text-center font-medium sm:text-lg sm:font-serif'>© Copyright 2022-2023 www.MealsNearYou.com All rights reserved.</p>
      </div> */}
