      ...
      <div className="card grid grid-cols-1 my-5 mx-4  sm:grid-cols-1 sm:grid lg:grid lg:grid-cols-2 gap-6 md:px-8 px-2" >
        <Fade direction='left'>
          <div className='border-2 border-gray-600 rounded-md grid sm:grid-cols-2'>
            <img src="https://eathomie-com.s3.amazonaws.com/images/home-made-food-1224.jpg" alt="image1" className='w-auto order-1 h-full p-4 rounded-3xl' />
            <h1 className="text-center text-2xl py-5 order-2 sm:flex sm:justify-center sm:items-center padding:2px" >Made With 🖤 By Home🏠 <br /> Chef🧑‍🍳 Only</h1>
          </div>
        </Fade>
        <Fade direction='right'>
          <div className='border-2 border-gray-600 rounded-md grid sm:grid-cols-2'>
            <img src="https://eathomie-com.s3.amazonaws.com/images/small-batch-1224.jpg" alt="image1" className='w-auto sm:order-2 lg:order-1 h-full p-4 rounded-3xl' />
        ...
        <Fade direction = 'left'>
          <div className='border-2 border-gray-600 rounded-md grid sm:grid-cols-2'>
            <img src="https://eathomie-com.s3.amazonaws.com/images/fresh-food-1224.jpg" alt="image1" className='w-auto md:order-1 lg:order-2 h-full p-4 rounded-3xl' />
        ...
        <Fade direction='right'>
          <div className='border-2 border-gray-600 rounded-md grid sm:grid-cols-2'>
            <img src="https://eathomie-com.s3.amazonaws.com/images/disposable-packaging.jpg" alt="image1" className='w-full sm:order-2 lg:order-2 p-4 rounded-3xl' />
