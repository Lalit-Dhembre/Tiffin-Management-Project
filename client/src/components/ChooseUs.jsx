...
function ChooseUs() {
  ...
  return (
    ...
    <div className=" mx-auto py-5 bg-gray-100 " style={{ fontFamily: 'Anek Devanagari' }}>
      ...
      <div className="card grid grid-cols-1 my-5 mx-4  sm:grid-cols-1 sm:grid lg:grid lg:grid-cols-2 gap-6 md:px-8 p-1" >
        <div className='border-2 border-gray-600 rounded-md grid sm:grid-cols-2' data-aos="fade-right" data-aos-duration="1500">
          <img src="https://eathomie-com.s3.amazonaws.com/images/home-made-food-1224.jpg" alt="image1" className='w-auto order-1 h-full p-2' />
          <h1 className="text-center text-2xl py-5 order-2 sm:flex sm:justify-center sm:items-center " >Made With 🖤 Byyy Home🏠 <br /> Chef🧑‍🍳 Only</h1>
        </div>
        ...
        <div className='border-2 border-gray-600 rounded-md grid sm:grid-cols-2' data-aos="fade-left" data-aos-duration="1500">
          <img src="https://eathomie-com.s3.amazonaws.com/images/disposable-packaging.jpg" alt="image1" className='w-full sm:order-2 lg:order-2'/>
